(function (global, factory) {
  ...
  function useIsFetching(arg1, arg2, arg3) {
    ...
    return shim.exports.useSyncExternalStore(React__default["default"].useCallback(onStoreChange => queryCache.subscribe(notifyManager.batchCalls(onStoreChange)), [queryCache]), () => queryClient.isFetching(filters), () => queryClient.isFetching(filters));
  }
  ...
  function useIsMutating(arg1, arg2, arg3) {
    ...
    const queryCache = queryClient.getQueryCache();
    return shim.exports.useSyncExternalStore(React__default["default"].useCallback(onStoreChange => queryCache.subscribe(notifyManager.batchCalls(onStoreChange)), [queryCache]), () => queryClient.isMutating(filters), () => queryClient.isMutating(filters));
  }
  ...
  function useMutation(arg1, arg2, arg3) {
    ...
    const result = shim.exports.useSyncExternalStore(React__default["default"].useCallback(onStoreChange => observer.subscribe(notifyManager.batchCalls(onStoreChange)), [observer]), () => observer.getCurrentResult(), () => observer.getCurrentResult());
  ...
  function useBaseQuery(options, Observer) {
    ...
    shim.exports.useSyncExternalStore(React__default["default"].useCallback(onStoreChange => isRestoring ? () => undefined : observer.subscribe(notifyManager.batchCalls(onStoreChange)), [observer, isRestoring]), () => observer.getCurrentResult(), () => observer.getCurrentResult());
    React__default["default"].useEffect(() => {
