...
export declare type QueryFunction<T = unknown, TQueryKey extends QueryKey = QueryKey> = (context: QueryFunctionContext<TQueryKey>) => [T] extends [undefined] ? never | 'queryFn must not return undefined or void' : [T] extends [void] ? never | 'queryFn must not return undefined or void' : T | Promise<T>;
