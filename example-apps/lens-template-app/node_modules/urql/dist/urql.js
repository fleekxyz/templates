...
function useMutation(n) {
  ...
  var s = i[0];
  var c = i[1];
  var f = t.useCallback((function(t, i) {
    c(_extends({}, o, {
      fetching: !0
    }));
    return r.toPromise(a.executeMutation(e.createRequest(n, t), i || {})).then((function(e) {
      if (u.current) {
        c({
          fetching: !1,
          stale: !!e.stale,
...
function useQuery(e) {
  ...
  var s = t.useMemo((function() {
    ...
    var t = n.executeQuery(i, _extends({}, {
      requestPolicy: e.requestPolicy
    }, e.context));
    return a ? r.onPush((function(e) {
      u.set(i.key, e);
    }))(t) : t;
  }), [ u, n, i, a, e.pause, e.requestPolicy, e.context ]);
  ...
  var l = [ n, i, e.requestPolicy, e.context, e.pause ];
  var v = t.useState((function() {
    c = !0;
    try {
      return [ s, computeNextState(o, f(s, a)), l ];
    } finally {
      c = !1;
    }
  }));
  ...
  if (s !== p[0] && hasDepsChanged(p[2], l)) {
    d([ s, x = computeNextState(p[1], f(s, a)), l ]);
  }
  t.useEffect((function() {
    var e = p[0];
    var t = p[2][1];
    ...
    if (e) {
      var a = r.subscribe(updateResult)(r.onEnd((function() {
        updateResult({
          fetching: !1
        });
      }))(e));
  ...
  return [ x, t.useCallback((function(t) {
    ...
    d((function(e) {
      return [ a ? r.onPush((function(e) {
        u.set(i.key, e);
      }))(n.executeQuery(i, s)) : n.executeQuery(i, s), e[1], l ];
    }));
  }), [ n, u, i, a, f, e.requestPolicy, e.context ]) ];
}
...
function useSubscription(e, n) {
  ...
  i.current = n;
  var s = t.useMemo((function() {
    return !e.pause ? u.executeSubscription(a, e.context) : null;
  }), [ u, a, e.pause, e.context ]);
  var c = [ u, a, e.context, e.pause ];
  ...
  t.useEffect((function() {
    function updateResult(e) {
      v((function(t) {
        ...
        if (i.current && t[1].data !== r.data) {
          r.data = i.current(t[1].data, r.data);
        }
        return [ t[0], r, t[2] ];
      }));
    }
  ...
  return [ p, t.useCallback((function(t) {
    var r = u.executeSubscription(a, _extends({}, e.context, t));
    v((function(e) {
      return [ r, e[1], e[2] ];
    }));
  }), [ u, e.context, a ]) ];
