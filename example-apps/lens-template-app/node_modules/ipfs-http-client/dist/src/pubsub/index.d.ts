...
export function createPubsub(config: import('../types').Options): {
    ...
    unsubscribe: (topic: string, handler: import("@libp2p/interfaces/dist/src/events.js").EventHandler<import("@libp2p/interface-pubsub").Message> | undefined) => Promise<void>;
};
