 ...
 */
export function createRm(client: import('../../lib/core').Client): ({ timeout, signal, headers, ...query }: import("ipfs-core-types/src/pin/remote").Query & import("ipfs-core-types").AbortOptions & import("../../types").HTTPClientExtraOptions) => Promise<void>;
