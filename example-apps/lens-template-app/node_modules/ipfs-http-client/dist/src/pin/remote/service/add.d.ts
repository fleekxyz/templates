 ...
 */
export function createAdd(client: import('../../../lib/core').Client): (name: string, options: import("ipfs-core-types/src/pin/remote/service").Credentials & import("ipfs-core-types").AbortOptions & import("../../../types").HTTPClientExtraOptions) => Promise<void>;
