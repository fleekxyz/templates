...
export function createBlock(config: import('../types').Options): {
    ...
    put: (data: Uint8Array, options?: (import("ipfs-core-types/src/block/index.js").PutOptions & import("../types").HTTPClientExtraOptions) | undefined) => Promise<import("multiformats").CID<unknown, number, number, import("multiformats").Version>>;
