...
export declare type SignaturePolicy = typeof StrictSign | typeof StrictNoSign;
...
export declare type Message = SignedMessage | UnsignedMessage;
...
export interface PubSub<Events extends {
    [s: string]: any;
} = PubSubEvents> extends EventEmitter<Events> {
